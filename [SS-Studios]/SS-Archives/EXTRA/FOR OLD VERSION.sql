...
ALTER TABLE `ss_archives` CHANGE COLUMN `payed` `fake` INT(11) NULL DEFAULT '0' AFTER `fine`;
ALTER TABLE `ss_archives` ADD COLUMN `penal` INT(11) NULL DEFAULT '0' AFTER `u_charid`;
