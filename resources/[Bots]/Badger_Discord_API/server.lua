...
card = '{"type":"AdaptiveCard","$schema":"http://adaptivecards.io/schemas/adaptive-card.json","version":"1.3","body":[{"type":"Image","url":"'.. Config.Splash.Header_IMG .. '","horizontalAlignment":"Center"},{"type":"Container","items":[{"type":"TextBlock","text":"Bem Vindos ao Estado","wrap":true,"fontType":"Default","size":"ExtraLarge","weight":"Bolder","color":"Light","horizontalAlignment":"Center"},{"type":"ActionSet","actions":[{"type":"Action.OpenUrl","title":"Crie sua história, viva ela e seja eterno!","style":"destructive","iconUrl":"","url":""}]}],"style":"default","bleed":true,"height":"stretch"},{"type":"Image","url":"","selectAction":{"type":"Action.OpenUrl","url":""},"horizontalAlignment":"Center"}]}'
