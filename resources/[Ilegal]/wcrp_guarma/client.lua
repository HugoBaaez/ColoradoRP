	...
	while true do
        ...
        if (Vdist(coords.x, coords.y, coords.z, 2671.13, -1552.96, 46.47) < 2.0) then
            ...
            if IsControlJustReleased(0, 0x760A9C6F) then
                ...
                if Config.transitions == true then Citizen.InvokeNative(0x1E5B70E53DB661E5, 0, 0, 0, 'Guarma', 'A baía da paz', 'Seu barco está navegando . .') end
...
Citizen.CreateThread(function() -- TP Back from Guarma
    ...
    if (Vdist(coords.x, coords.y, coords.z, 1265.8421, -6852.1635, 43.4185) < 2.0) then
		...
		FreezeEntityPosition(Ped,true)
                Wait(3000)
                if Config.transitions == true then DoScreenFadeIn(500) end
		if Config.transitions == true then Citizen.InvokeNative(0x1E5B70E53DB661E5, 0, 0, 0, 'Continente', 'Porto de Saint Denis', 'Sentindo-se revigorado . .') end
