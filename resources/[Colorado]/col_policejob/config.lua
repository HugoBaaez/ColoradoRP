...
Marshal_DutyWeapons = {
    guns = {
        {label = "Revolver Lemat", weapon = "WEAPON_REVOLVER_LEMAT", ammo = {["AMMO_REVOLVER"] = 100}, comps = {['nothing'] = 0}},
        {label = "Revolver Schofield", weapon = "WEAPON_REVOLVER_SCHOFIELD", ammo = {["AMMO_REVOLVER"] = 100}, comps = {['nothing'] = 0}},
        {label = "Revolver Navy", weapon = "WEAPON_REVOLVER_NAVY", ammo = {["AMMO_REVOLVER"] = 100}, comps = {['nothing'] = 0}},
        {label = "Rifle de Ferrolho", weapon = "WEAPON_RIFLE_BOLTACTION", ammo = {["AMMO_REPEATER"] = 100}, comps = {['nothing'] = 0}},
        {label = "Carabina de Repetição", weapon = "WEAPON_REPEATER_CARBINE", ammo = {["AMMO_REPEATER"] = 100}, comps = {['nothing'] = 0}},
        {label = "Repetidor Winchester", weapon = "WEAPON_REPEATER_WINCHESTER", ammo = {["AMMO_REPEATER"] = 100}, comps = {['nothing'] = 0}},
        {label = "Repetidor Evans", weapon = "WEAPON_REPEATER_EVANS", ammo = {["AMMO_REPEATER"] = 100}, comps = {["nothing"] = 0}}
    }
}
