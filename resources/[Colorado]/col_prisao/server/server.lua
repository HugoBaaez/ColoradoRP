...
AddEventHandler("vorp:updateJail", function(playerId, steamid, jailName, jailTime)
	...
	exports.oxmysql:execute("UPDATE characters SET jail=@jailname, jailtime=@jailtime WHERE identifier=@id", 
...
AddEventHandler("vorp:getJail", function()
	...
	exports.oxmysql:execute("SELECT jail,jailtime FROM characters WHERE identifier=@id", {['@id']=identifier}, function(result)
