...
local boates = {
		[1] = {
		['Text'] = "~q~Canoa de tronco de árvore ~t1~[$5,20]", --1--
		['SubText'] = "",
		['Desc'] = "Nivel necessario [0]",
		['Param'] = {
			['Preço'] = 5.20,
			['Modelo'] = "CANOETREETRUNK",
			['Level'] = 0
		}
	},

		[2] = {
		['Text'] = "~q~Canoa Longa 1 ~t1~[$6,34]", --2--
		['SubText'] = "",
		['Desc'] = "Nivel necessario [5]",
		['Param'] = {
			['Preço'] = 6.34,
			['Modelo'] = "PIROGUE",
			['Level'] = 0
		...
		[3] = {
		['Text'] = "~q~Canoa Longa 2 ~t1~[$6,50]", --3--
		['SubText'] = "",
		['Desc'] = "Nivel necessario [0]",
		['Param'] = {
			['Preço'] = 6.50,
	    ...
	    [5] = {
		['Text'] = "~q~Barco a remo dos pântanos 1 ~t1~[$15,32]", --5--
		['SubText'] = "",
		['Desc'] = "",
		['Param'] = {
			['Preço'] = 15.32,
			['Modelo'] = "rowboatSwamp02",
			['Level'] = 0
		}
	},

		[6] = {
		['Text'] = "~q~Barco a remo dos pântanos 2 ~t1~[$17,21]", --6--
		['SubText'] = "",
		['Desc'] = "Nivel necessario [0]",
		['Param'] = {
			['Preço'] = 17.21,
		...
		[7] = {
		['Text'] = "~q~Barco a remo clássico ~t1~[$20,34]", --7--
		['SubText'] = "",
		['Desc'] = "Nivel necessario [0]",
		['Param'] = {
			['Preço'] = 20.34,
		...
		[8] = {
		['Text'] = "~q~Barco a vapor fechado ~t1~[$450,0]", --8--
		['SubText'] = "",
		['Desc'] = "Nivel necessario [0]",
		['Param'] = {
			['Preço'] = 450,
		...
		[9] = {
		['Text'] = "~q~Barco a vapor clássico ~t1~[$500,0]", --9--
		['SubText'] = "",
		['Desc'] = "Nivel necessario [0]",
		['Param'] = {
			['Preço'] = 500,
...
Citizen.CreateThread( function()
	WarMenu.CreateMenu('id_boat', 'Loja de barcos.')
	while true do
