...
RegisterServerEvent("vorp_admin:givePlayer", function(targetID, type, data1, data2, data3)
    ...
    if targetID then
        ...
        elseif type == "horse" then
            ...
            local name = data2
            local sex = data3
            exports.oxmysql:execute("INSERT INTO horses ( `identifier`, `charid`, `name`, `model`, `sex`) VALUES ( @identifier, @charid, @name, @model, @sex)"
        ...
        elseif type == "wagon" then
            ...
            local hash = data1
            local name = data2
            exports.oxmysql:execute("INSERT INTO wagons ( `identifier`, `charid`, `name`, `model`) VALUES ( @identifier, @charid, @name, @model)"
                , { ['identifier'] = identifier, ['charid'] = charid, ['name'] = tostring(name),
                ['model'] = hash })
            TriggerClientEvent("vorp:TipRight", targetID,
