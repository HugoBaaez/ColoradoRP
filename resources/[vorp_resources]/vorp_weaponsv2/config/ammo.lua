...
Config3.ammo = { -- both crafting and shops
    ["Repetidor"] = {
        ["Munição de repetidor Normal"] = {
            ...
            jobs = {"rdguns", "armariaSaintDenis", "armariaValentine", "Bwguns","armaria"}, -- jobs that can craft this weapon is job only is true 
            ...
            materials = {
                ...
                item2 = {name = "grafite", amount = 1},
                item3 = {name = "magnetite", amount = 1},
            }, 
        },
    --[[    ["Repeater Ammo Express"] = {
            ...
            materials = {
                item1 = {name = "ferro", amount = 5},
                item2 = {name = "grafite", amount = 5},
                item3 = {name = "magnetite", amount = 5},
            }, 
        },
        ...
        ["Repeater Ammo Velocity"] = {
            ...
            qt = 10, -- number of bullets in box	    
            materials = {
                item1 = {name = "ferro", amount = 8},
                item2 = {name = "grafite", amount = 8},
                item3 = {name = "magnetite", amount = 8},
            }, 
        },
        ["Repeater Ammo Splitpoint"] = {
            ...
            materials = {
                item1 = {name = "ferro", amount = 6},
                item2 = {name = "grafite", amount = 6},
                item3 = {name = "magnetite", amount = 6},
            }, 
        },]]
    },

    ["Revolver"] = {
        ["Munição do revólver Normal"] = {
            key = "AMMO_REVOLVER",-- DO NOT CHANGE THESE  
            item = "ammorevolvernormal",
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            jobonly = true, -- turn this to true if you want crafting this weapon to only be allowed for a certain job
            jobs = {"rdguns", "armariaSaintDenis", "armariaValentine","Bwguns"}, -- jobs that can craft this weapon is job only is true 
            maxammo = 200, -- max ammo allowed by game 
    ...
    --[[    ["Revolver Ammo Express"] = {
            ...
            qt = 10, -- number of bullets in box    
            materials = {
                item1 = {name = "ferro", amount = 3},
                item2 = {name = "grafite", amount = 3},
                item3 = {name = "magnetite", amount = 3},
            }, 
        },
    ...
    --[[    ["Elephant Rifle Ammo"] = {
            ...
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            jobonly = false, -- turn this to true if you want crafting this weapon to only be allowed for a certain job
            jobs = {"Armeiro", "ChefeArmeiro"}, -- jobs that can craft this weapon is job only is true 
            maxammo = 20, -- max ammo allowed by game 
            guncheck = 0x0A82317B7EBFC420 ,-- DO NOT CHANGE THESE 
            guncheck2 = 0x6AD66548840472E5,
            qt = 10, -- number of bullets in box 
            materials = {
                item1 = {name = "ferro", amount = 10},
                item2 = {name = "grafite", amount = 10},
                item3 = {name = "magnetite", amount = 10},
            }, 
        },
        ["Rifle Ammo Express"] = {
        ...
        ["Rifle Ammo Splitpoint"] = {
            ...
            qt = 50, -- number of bullets in box	    
            materials = {
                item1 = {name = "ferro", amount = 11},
                item2 = {name = "grafite", amount = 11},
                item3 = {name = "magnetite", amount = 11},
            }, 
        },]] 
    ...
    ["Shotgun"] = {
        ["Shotgun Ammo Incendiary"] = {
            ...
            letcraft = false, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            jobonly = false, -- turn this to true if you want crafting this weapon to only be allowed for a certain job
            jobs = {"police"}, -- jobs that can craft this weapon is job only is true 
            maxammo = 200, -- max ammo allowed by game 
        ...
        ["Shotgun Ammo Explosive"] = {
         ...
         ["Munição de escopeta Normal"] = {
            key = "AMMO_SHOTGUN", 
            item = "ammoshotgunnormal",
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            jobonly = true, -- turn this to true if you want crafting this weapon to only be allowed for a certain job
            jobs = {'armaria'}, -- jobs that can craft this weapon is job only is true 
            maxammo = 100,
            guncheck = 0xC75386174ECE95D5  ,
            qt = 5, -- number of bullets in box
            materials = {
                item1 = {name = "ferro", amount = 5},
                item2 = {name = "rocks", amount = 2},
                item3 = {name = "magnetite", amount = 2},
            }, 
        },
       ["Shotgun Ammo Slug"] = {
    ...
    ["Pistola"] = {
        ["Munição de pistola Normal"] = {
            ...
            materials = {
                item1 = {name = "ferro", amount = 1},
                item2 = {name = "magnetite", amount = 1},
                item3 = {name = "rocks", amount = 1},
            }, 
        },
    --[[    ["Pistol Ammo Express"] = {
    ...
    ["Flechas"] = {
        ["Flecha Normal"] = {
            ...
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            jobonly = true, -- turn this to true if you want crafting this weapon to only be allowed for a certain job
            jobs = {"rdguns", "armariaSaintDenis", "armariaValentine","indios","Bwguns","indiosBW", "indiosAR"}, -- jobs that can craft this weapon is job only is true 
            maxammo = 40, -- max ammo allowed by game 
            guncheck = 0 ,-- DO NOT CHANGE THESE 
            qt = 20, -- number of bullets in box 
            materials = {
                item1 = {name = "ferro", amount = 2},
                item2 = {name = "toco_pinho", amount = 2},
                item3 = {name = "feather", amount = 1},
            }, 
        },
    --[[    ["Arrow Dynamite"] = {
            ...
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            jobonly = false, -- turn this to true if you want crafting this weapon to only be allowed for a certain job
            jobs = {"Armeiro"}, -- jobs that can craft this weapon is job only is true 
            maxammo = 8,
            guncheck = 0  ,
            qt = 4, -- number of bullets in box    
            materials = {
                item1 = {name = "feather", amount = 2},
                item2 = {name = "toco_pinho", amount = 2},
                item3 = {name = "animalfat", amount = 2},
            }, 
        },]]
        ["Flecha de Fogo"] = {
            key = "AMMO_ARROW_FIRE", 
            ...
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            jobonly = true, -- turn this to true if you want crafting this weapon to only be allowed for a certain job
            jobs = {"indios", "indiosBW", "indiosAR"}, -- jobs that can craft this weapon is job only is true 
            maxammo = 10,
            guncheck = 0  ,
            qt = 4, -- number of bullets in box
            materials = {
        ...
        ["Flecha Melhorada"] = {
            ...
            materials = {
                item1 = {name = "ferro", amount = 3},
                item2 = {name = "toco_pinho", amount = 3},
                item3 = {name = "feather", amount = 3},
            }, 
        },
    --[[    ["Arrow Small Game"] = {
        ...
        ["Flecha Venenosa"] = {
            ...
            materials = {
                item1 = {name = "feather", amount = 2},
                item2 = {name = "toco_pinho", amount = 2},
                item3 = {name = "snakepoison", amount = 1},
            }, 
        },
    ...
    --[[   ["Knives ammo"] = {
       ...
       ["Poison Bottle Ammo"] = {
            ...
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            jobonly = false, -- turn this to true if you want crafting this weapon to only be allowed for a certain job
            jobs = {"Herbalista"}, -- jobs that can craft this weapon is job only is true 
            maxammo = 3, -- max ammo allowed by game 
            guncheck = 0  ,-- DO NOT CHANGE THESE 
            qt = 3, -- number of bullets in box 
            materials = {
                item1 = {name = "moonshine", amount = 1},
                item2 = {name = "feather", amount = 3},
                item3 = {name = "veleno_s", amount = 3},
            }, 
        },
    --[[    ["Bollas Ammo"] = {
            ...
            letcraft = true, -- show in crafting u can toggle this to false if you want to make this weapon sellable but not craftable
            jobonly = true, -- turn this to true if you want crafting this weapon to only be allowed for a certain job
            jobs = {"rdguns", "armariaSaintDenis", "armariaValentine","Bwguns", "Herbalista"}, -- jobs that can craft this weapon is job only is true 
            maxammo = 3, -- max ammo allowed by game 
            guncheck = 0  ,-- DO NOT CHANGE THESE 
            qt = 3, -- number of bullets in box 
            materials = {
                item1 = {name = "ferro", amount = 0},
