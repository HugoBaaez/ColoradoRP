...
Config.MarkerForSaveHorse = false
Config.OnlyTrainerSeeStats = true
...
Config.HealPrice = 5--If you have disable Heal horse this "strong" price 5$
...
Config.SimulateNodes = {
    --x,y,z,h
    [1] = {1012.510498046875,-1702.018310546875,45.8022346496582,350.778076171875, 20.0},
    [2] = {1011.9470825195312,-1636.866455078125,46.39780807495117,1.2416785955429, 20.0}
}
...
Config.Language = {
    ...
    [362] = {time=5000, text = "O Cavalo pode ter 10 Ferraduras"},
...
Config.SpotsForStable = {
    ...
    [5] =  {
        ...
        ["CamPosHorse"] = {-3689.79, -2564.83, -10.83, -149.78},
