...
RegisterCommand('corvo', function (source, args, rawCommand)
    TriggerServerEvent('ped4check')
end)
RegisterCommand('puma', function (source, args, rawCommand)
    TriggerServerEvent('ped5check')
end)

RegisterCommand('ped', function (source, args, rawCommand)
    TriggerServerEvent('ped6check')
end)
RegisterCommand('ped2', function (source, args, rawCommand)
    TriggerServerEvent('pedcheck')
end)
RegisterCommand('husky', function (source, args, rawCommand)
    TriggerServerEvent('ped7check')
end)
RegisterCommand('karen', function (source, args, rawCommand)
    TriggerServerEvent('ped8check')
end)
RegisterCommand('mary', function (source, args, rawCommand)
    TriggerServerEvent('ped9check')
end)
RegisterCommand('sadler', function (source, args, rawCommand)
    TriggerServerEvent('ped10check')
end)
RegisterCommand('hawk', function (source, args, rawCommand)
    TriggerServerEvent('ped13check')
end)
RegisterCommand('ped14', function (source, args, rawCommand)
    TriggerServerEvent('ped14check')
end)
RegisterCommand('ped15', function (source, args, rawCommand)
    TriggerServerEvent('ped15check')
end)

-- ped1
RegisterNetEvent("1lobo")
AddEventHandler("1lobo", function()
...
-- ped1
RegisterNetEvent("coruja")
AddEventHandler("coruja", function()
	local ped = PlayerPedId()
	TaskStartScenarioInPlace(ped, GetHashKey('WORLD_HUMAN_CROUCH_INSPECT'), 5000, true, false, false, false)
	exports['progressBars']:startUI(5000, "Aguarde...") Wait(5000)
	ClearPedTasksImmediately(ped)
...
RegisterNetEvent("2lobo")
AddEventHandler("2lobo", function()
	local ped = PlayerPedId()
	TaskStartScenarioInPlace(ped, GetHashKey('WORLD_HUMAN_CROUCH_INSPECT'), 5000, true, false, false, false)
	exports['progressBars']:startUI(5000, "Aguarde...") Wait(5000)
	ClearPedTasksImmediately(ped)
...
RegisterNetEvent("ped4")
AddEventHandler("ped4", function()
	local ped = PlayerPedId()
	TaskStartScenarioInPlace(ped, GetHashKey('WORLD_HUMAN_CROUCH_INSPECT'), 5000, true, false, false, false)
	exports['progressBars']:startUI(5000, "Aguarde...") Wait(5000)
	ClearPedTasksImmediately(ped)
...
RegisterNetEvent("ped5")
AddEventHandler("ped5", function()
	local ped = PlayerPedId()
	TaskStartScenarioInPlace(ped, GetHashKey('WORLD_HUMAN_CROUCH_INSPECT'), 5000, true, false, false, false)
	exports['progressBars']:startUI(5000, "Aguarde...") Wait(5000)
	ClearPedTasksImmediately(ped)
...
RegisterNetEvent("ped6")
AddEventHandler("ped6", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_jackmarston")
end)
RegisterNetEvent("ped7")
AddEventHandler("ped7", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_DogHusky_01")
end)
RegisterNetEvent("ped8")
AddEventHandler("ped8", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_karen")
end)
RegisterNetEvent("ped9")
AddEventHandler("ped9", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_marybeth")
end)
RegisterNetEvent("ped10")
AddEventHandler("ped10", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_mrsadler")
end)
RegisterNetEvent("ped11")
AddEventHandler("ped11", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_abigailroberts")
end)
RegisterNetEvent("ped12")
AddEventHandler("ped12", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_mollyoshea")
end)


RegisterNetEvent("ped13")
AddEventHandler("ped13", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_Hawk_01")
end)

RegisterNetEvent("ped14")
AddEventHandler("ped14", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_FamousGunslinger_05")
end)

RegisterNetEvent("ped15")
AddEventHandler("ped15", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_susangrimshaw")
end)
RegisterNetEvent("ped16")
AddEventHandler("ped16", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_creepyoldlady")
end)
RegisterNetEvent("ped17")
AddEventHandler("ped17", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_twingroupie_01")
end)
RegisterNetEvent("ped18")
AddEventHandler("ped18", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_F_M_ValProstitute_01")
end)
RegisterNetEvent("ped19")
AddEventHandler("ped19", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_bandsinger")
end)
RegisterNetEvent("ped20")
AddEventHandler("ped20", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("cs_marylinton")
end)
RegisterNetEvent("ped21")
AddEventHandler("ped21", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_penelopebraithwaite")
end)
RegisterNetEvent("ped22")
AddEventHandler("ped22", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_AgnesDowd")
end)
RegisterNetEvent("ped23")
AddEventHandler("ped23", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_GermanSon")
end)
RegisterNetEvent("ped24")
AddEventHandler("ped24", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_AgnesDowd")
end)
RegisterNetEvent("ped25")
AddEventHandler("ped25", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_MAMAWATSON")
end)
RegisterNetEvent("ped26")
AddEventHandler("ped26", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_MP_TRAVELLINGSALESWOMAN")
end)
RegisterNetEvent("ped27")
AddEventHandler("ped27", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_F_M_ArmTownfolk_02")
end)
RegisterNetEvent("ped28")
AddEventHandler("ped28", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("MP_PREDATOR")
end)
RegisterNetEvent("ped29")
AddEventHandler("ped29", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_obediahhinton")
end)
RegisterNetEvent("ped30")
AddEventHandler("ped30", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_DUTCH")
end)
RegisterNetEvent("ped31")
AddEventHandler("ped31", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_javierescuella")
end)
RegisterNetEvent("ped32")
AddEventHandler("ped32", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_EagleFlies")
end)
RegisterNetEvent("ped33")
AddEventHandler("ped33", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_ValProstitute_02")
end)
RegisterNetEvent("ped34")
AddEventHandler("ped34", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_F_M_RhdProstitute_01")
end)
RegisterNetEvent("ped35")
AddEventHandler("ped35", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_Fire_Breather")
end)
RegisterNetEvent("ped36")
AddEventHandler("ped36", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_LillianPowell")
end)
RegisterNetEvent("ped37")
AddEventHandler("ped37", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_MP_ALLISON")
end)
RegisterNetEvent("ped38")
AddEventHandler("ped38", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_BATHINGLADIES_01")
end)
RegisterNetEvent("ped39")
AddEventHandler("ped39", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_GermanDaughter")
end)
RegisterNetEvent("ped40")
AddEventHandler("ped40", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_hercule")
end)
RegisterNetEvent("ped41")
AddEventHandler("ped41", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_LondonderrySon")
end)
RegisterNetEvent("ped42")
AddEventHandler("ped42", function() 
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_ValProstitute_02")
end)
RegisterNetEvent("ped43")
AddEventHandler("ped43", function() 
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_AgnesDowd")
end)
RegisterNetEvent("ped44")
AddEventHandler("ped44", function() 
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_PAYTAH")
end)
RegisterNetEvent("ped45")
AddEventHandler("ped45", function() 
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_SOOTHSAYER")
end)
RegisterNetEvent("ped46")
AddEventHandler("ped46", function() 
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_M_M_BTCObeseMen_01")
end)
RegisterNetEvent("ped47")
AddEventHandler("ped47", function() 
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_Magnifico")
end)
RegisterNetEvent("ped48")
AddEventHandler("ped48", function() 
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_AberdeenPigFarmer")
end)
RegisterNetEvent("ped49")
AddEventHandler("ped49", function() 
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_brotherdorkins")
end)
RegisterNetEvent("ped50")
AddEventHandler("ped50", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_beaugray")
end)
RegisterNetEvent("ped51")
AddEventHandler("ped51", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_sean")
end)
RegisterNetEvent("ped52")
AddEventHandler("ped52", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_F_M_BTCObeseWomen_01")
end)
RegisterNetEvent("ped53")
AddEventHandler("ped53", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_tilly")
end)
RegisterNetEvent("ped54")
AddEventHandler("ped54", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_MrsWeathers")
end)
RegisterNetEvent("ped55")
AddEventHandler("ped55", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_M_M_BLWObeseMen_01")
end)
RegisterNetEvent("ped56")
AddEventHandler("ped56", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_MicahBell")
end)
RegisterNetEvent("ped57")
AddEventHandler("ped57", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_DogCollie_01")
end)
RegisterNetEvent("ped58")
AddEventHandler("ped58", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_Cat_01")
end)
RegisterNetEvent("ped59")
AddEventHandler("ped59", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_SUNWORSHIPPER")
end)
RegisterNetEvent("ped60")
AddEventHandler("ped60", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_F_M_HtlFancyTravellers_01")
end)
RegisterNetEvent("ped61")
AddEventHandler("ped61", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_Parrot_01")
end)
RegisterNetEvent("ped62")
AddEventHandler("ped62", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_ValProstitute_01")
end)
RegisterNetEvent("ped63")
AddEventHandler("ped63", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("U_M_M_BHT_LOVER")
end)
RegisterNetEvent("ped64")
AddEventHandler("ped64", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("MP_U_F_M_LEGENDARYBOUNTY_03")
end)
RegisterNetEvent("ped65")
AddEventHandler("ped65", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("RCSP_ODRISCOLLS2_FEMALES_01")
end)
RegisterNetEvent("ped66")
AddEventHandler("ped66", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("MP_ASN_BENEDICTPOINT_FEMALES_01")
end)
RegisterNetEvent("ped67")
AddEventHandler("ped67", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_johnmarston")
end)
RegisterNetEvent("ped68")
AddEventHandler("ped68", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_F_M_SDFancyWhore_01")
end)
RegisterNetEvent("ped69")
AddEventHandler("ped69", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_DOROETHEAWICKLOW")
end)
RegisterNetEvent("ped70")
AddEventHandler("ped70", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_ColmODriscoll")
end)
RegisterNetEvent("ped71")
AddEventHandler("ped71", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_JAMIE")
end)
RegisterNetEvent("ped72")
AddEventHandler("ped72", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_forgivenwife_01")
end)
RegisterNetEvent("ped73")
AddEventHandler("ped73", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_FamousGunslinger_06")
end)
RegisterNetEvent("ped74")
AddEventHandler("ped74", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_GuidoMartelli")
end)
RegisterNetEvent("ped75")
AddEventHandler("ped75", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_DogAustralianSheperd_01")
end)
RegisterNetEvent("ped76")
AddEventHandler("ped76", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_HERBALIST")
end)
RegisterNetEvent("ped77")
AddEventHandler("ped77", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_charlessmith")
end)
RegisterNetEvent("ped78")
AddEventHandler("ped78", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_DogLab_01")
end)
RegisterNetEvent("ped79")
AddEventHandler("ped79", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("RE_RALLY_MALES_01")
end)
RegisterNetEvent("ped80")
AddEventHandler("ped80", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_PrincessIsabeau")
end)
RegisterNetEvent("ped81")
AddEventHandler("ped81", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("RE_RALLYSETUP_MALES_01")
end)
RegisterNetEvent("ped82")
AddEventHandler("ped82", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("U_M_M_NbxPriest_01")
end)
RegisterNetEvent("ped83")
AddEventHandler("ped83", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_MP_HARRIET_DAVENPORT")
end)
RegisterNetEvent("ped84")
AddEventHandler("ped84", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_johnmarston")
end)
RegisterNetEvent("ped85")
AddEventHandler("ped85", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_lenny")
end)
RegisterNetEvent("ped86")
AddEventHandler("ped86", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_tilly")
end)
RegisterNetEvent("ped87")
AddEventHandler("ped87", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_PoisonWellShaman")
end)
RegisterNetEvent("ped88")
AddEventHandler("ped88", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("Cs_mp_bonnie")
end)
RegisterNetEvent("ped89")
AddEventHandler("ped89", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_SD_STREETKID_01B")
end)
RegisterNetEvent("ped90")
AddEventHandler("ped90", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_M_M_BLWObeseMen_01")
end)
RegisterNetEvent("ped91")
AddEventHandler("ped91", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_M_M_SDObesemen_01")
end)
RegisterNetEvent("ped92")
AddEventHandler("ped92", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_M_M_RHDObeseMen_01")
end)
RegisterNetEvent("ped93")
AddEventHandler("ped93", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_TAXIDERMIST")
end)
RegisterNetEvent("ped94")
AddEventHandler("ped94", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_MP_JESSICA")
end)
RegisterNetEvent("ped95")
AddEventHandler("ped95", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_DogRufus_01")
end)
RegisterNetEvent("ped96")
AddEventHandler("ped96", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_sistercalderon")
end)
RegisterNetEvent("ped97")
AddEventHandler("ped97", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_DogChesBayRetriever_01")
end)
RegisterNetEvent("ped98")
AddEventHandler("ped98", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_doglion_01")
end)
RegisterNetEvent("ped99")
AddEventHandler("ped99", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_LondonderrySon")
end)
RegisterNetEvent("ped100")
AddEventHandler("ped100", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("re_lostdog_dogs_01")
end)
RegisterNetEvent("ped101")
AddEventHandler("ped101", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("a_c_dogamericanfoxhound_01")
end)
RegisterNetEvent("ped102")
AddEventHandler("ped102", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("A_C_DogBluetickCoonhound_01")
end)
RegisterNetEvent("ped103")
AddEventHandler("ped103", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("cs_jackmarston_teen")
end)
RegisterNetEvent("ped104")
AddEventHandler("ped104", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_marybeth")
end)
RegisterNetEvent("ped105")
AddEventHandler("ped105", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_famousgunslinger_04")
end)
RegisterNetEvent("ped106")
AddEventHandler("ped106", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_MOIRA")
end)
RegisterNetEvent("ped107")
AddEventHandler("ped107", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_brendacrawley")
end)
RegisterNetEvent("ped108")
AddEventHandler("ped108", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("a_c_doghound_01")
end)
RegisterNetEvent("ped109")
AddEventHandler("ped109", function()
	Citizen.InvokeNative(0xD3A7B003ED343FD9 , PlayerPedId(),  0x1FC12C9C, true, true, true)
	SetMonModel("CS_twingroupie_02")
end)

RegisterCommand('pedmenu', function(source, args, rawCommand)
    TriggerServerEvent('lto_pedmenu:groupcheck')
end)
RegisterCommand('pedanim', function(source, args, rawCommand)
    TriggerServerEvent('lto_pedanim:groupcheck')
end)
...
Citizen.CreateThread(function()
	...
	WarMenu.CreateSubMenu('MenuSobrenatural', 'pedmenu', 'All peds from sobrenatural')
    ...
    while true do
        ...
        if WarMenu.IsMenuOpened('pedmenu') then
			...
			if WarMenu.MenuButton('Sobrenatural', 'MenuSobrenatural') then
			end
        ...
        elseif WarMenu.IsMenuOpened('MenuMale') then	
		    ...
		    elseif WarMenu.Button("(87) Card Game Players") then
			SetMonModel('CS_famousgunslinger_04')
            WarMenu.CloseMenu()
        ...
        elseif WarMenu.IsMenuOpened('MenuFemale') then -- FEMALE
			...
			elseif WarMenu.Button("(58) Val Prostitute 02") then
			SetMonModel('CS_ValProstitute_02')
			WarMenu.CloseMenu()
			
			elseif WarMenu.Button("(59) SDWEDDING FEMALE") then
				SetMonModel('MP_ASN_SDWEDDING_FEMALES_01')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(60) Bonnie") then
				SetMonModel('cs_mp_bonnie')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(61) Escape Artist") then 
				SetMonModel('CS_EscapeArtistAssistant')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(62) Forgiven Wife") then
				SetMonModel('CS_forgivenwife_01')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(63) Moira") then
				SetMonModel('CS_MOIRA')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(64) Grace Lancing") then
				SetMonModel('CS_MP_GRACE_LANCING')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(65) Nbx Receptionist") then
				SetMonModel('CS_nbxreceptionist_01')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(66) Tiger Handler") then
				SetMonModel('CS_TigerHandler')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(67) Twin Groupie") then 
				SetMonModel('CS_twingroupie_02')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(68) Val Prostitute 01") then
				SetMonModel('CS_ValProstitute_01')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(69) Benedict Female") then
				SetMonModel('MP_ASN_BENEDICTPOINT_FEMALES_01')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(70) Dead John Female") then
				SetMonModel('RE_DEADJOHN_FEMALES_01')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(71) Town Confrontation Females") then
				SetMonModel('RE_TOWNCONFRONTATION_FEMALES_01')
			WarMenu.CloseMenu()

			elseif WarMenu.Button("(72) BHT WIFE") then
				SetMonModel('U_F_M_BHT_WIFE')
			WarMenu.CloseMenu()
		...
		elseif WarMenu.IsMenuOpened('MenuSobrenatural') then -- TEEN

			if WarMenu.Button("(1) DeadAzulf1") then
				SetMonModel('A_F_M_ARMCHOLERACORPSE_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(2) DeadAzulf2") then
				SetMonModel('A_F_M_UniCorpse_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(3) DeadAzulm1") then
				SetMonModel('A_M_M_ARMCHOLERACORPSE_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(4) DeadAzulm2") then
				SetMonModel('A_M_M_UniCorpse_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(5) DeadAzulKid1") then
				SetMonModel('A_M_Y_UniCorpse_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(6) NoArmmale") then
				SetMonModel('CS_baptiste')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(7) Turtle") then
				SetMonModel('CS_ChelonianMaster')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(8) Deadmale1") then
				SetMonModel('CS_evelynmiller')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(9) Blueman") then
				SetMonModel('CS_genstorymale')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(10) Bluefemale") then
				SetMonModel('CS_genstoryfemale')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(11) Herbalistamale") then
				SetMonModel('CS_HERBALIST')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(12) JoeButlerNoleg") then
				SetMonModel('CS_JoeButler')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(13) malereligiousfreak") then
				SetMonModel('CS_JOHNTHEBAPTISINGMADMAN')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(14) amputedarmman") then
				SetMonModel('CS_Mickey')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(15) noheadguy") then
				SetMonModel('CS_MP_JORGE_MONTEZ')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(16) deadprostitute") then
				SetMonModel('CS_ODProstitute')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(17) AHSman") then
				SetMonModel('CS_oddfellowspinhead')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(18) freakshortarm") then
				SetMonModel('CS_SwampFreak')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(19) vampiro") then
				SetMonModel('CS_Vampire')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(20) freakbloodyman") then
				SetMonModel('G_M_M_UniInbred_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(21) hoodedguy") then
				SetMonModel('G_M_Y_UNIEXCONFEDS_02')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(22) bodydeadbloodyman") then
				SetMonModel('MES_SADIE4_MALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(23) mongedeadcego") then
				SetMonModel('MP_G_M_M_ARMYOFFEAR_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(24) mongedeadwoman") then
				SetMonModel('MP_G_F_M_ARMYOFFEAR_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(25) deadshootmale") then
				SetMonModel('RCSP_DUTCH1_MALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(26) deadmale2") then
				SetMonModel('RE_BOATATTACK_MALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(27) frozenmale") then
				SetMonModel('RE_FROZENTODEATH_MALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(28) frozenfemale") then
				SetMonModel('RE_FROZENTODEATH_FEMALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(29) deadtorso") then
				SetMonModel('RE_MURDERCAMP_MALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(30) deadwomanarrow1") then
				SetMonModel('RE_SAVAGEAFTERMATH_FEMALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(31) burnedcorpsemale") then
				SetMonModel('RE_SAVAGEAFTERMATH_MALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(32) deadwomanarrow2") then
				SetMonModel('RE_SAVAGEWAGON_FEMALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(33) deadmalearrow1") then
				SetMonModel('RE_SAVAGEWAGON_MALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(34) burnedcorpsemale2") then
				SetMonModel('RE_SAVAGEWARNING_MALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(35) deadmale3") then
				SetMonModel('RE_TOWNBURIAL_MALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(36) viuva") then
				SetMonModel('RE_TOWNWIDOW_FEMALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(37) whiteeyeshorrorwoman") then
				SetMonModel('RE_VOICE_FEMALES_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(38) doubleskellygirl") then
				SetMonModel('U_F_M_CIRCUSWAGON_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(39) heremitawoman") then
				SetMonModel('U_F_O_Hermit_woman_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(40) deadmale4") then
				SetMonModel('U_M_M_APFDeadMan_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(41) deadshootfacemale") then
				SetMonModel('U_M_M_BHT_OUTLAWMAULED')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(42) deadnoeyemale") then
				SetMonModel('U_M_M_BHT_ODRISCOLLMAULED')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(43) deadseita1") then
				SetMonModel('U_M_M_CHELONIANJUMPER_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(44) deadseita2") then
				SetMonModel('U_M_M_CHELONIANJUMPER_02')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(45) deadseita3") then
				SetMonModel('U_M_M_CHELONIANJUMPER_03')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(46) deadseita4") then
				SetMonModel('U_M_M_CHELONIANJUMPER_04')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(47) doubleskellyboy") then
				SetMonModel('U_M_M_CircusWagon_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(48) serialkiller") then
				SetMonModel('U_M_M_SHACKSERIALKILLER_01')
			WarMenu.CloseMenu()
	
	
			elseif WarMenu.Button("(49) deadazulkid2") then
				SetMonModel('U_M_Y_ShackStarvingKid_01')
			WarMenu.CloseMenu()
        ...
        elseif WarMenu.IsMenuOpened('MenuAnimalGround') then -- ANIMALS GROUND
			...
			elseif WarMenu.Button("(56) Wolf teste") then
			SetMonModel('MP_A_C_Wolf_01')
            WarMenu.CloseMenu()
...
RegisterNetEvent('lto_pedanim:open')
AddEventHandler('lto_pedanim:open', function(cb)
	WarMenu.OpenMenu('doganim')
end)

Citizen.CreateThread(function()
    WarMenu.CreateMenu('doganim', 'Ped Anim')
    WarMenu.SetSubTitle('doganim', 'Select Menu')
	WarMenu.CreateSubMenu('MenuDogAnim', 'doganim', 'Dog')
    WarMenu.CreateSubMenu('MenuCatAnim', 'doganim', 'Cat')
	while true do
		local playerPed = PlayerPedId()
		if WarMenu.IsMenuOpened('doganim') then
			
			if WarMenu.MenuButton('Dog', 'MenuDogAnim') then 
            end
			
			if WarMenu.MenuButton('Cat', 'MenuCatAnim') then
            end
		WarMenu.Display()
		elseif WarMenu.IsMenuOpened('MenuDogAnim') then
			if WarMenu.Button("Dog: Smell") then
			TriggerEvent("lto_pedmenu:dogsentir")
			...
			WarMenu.Display()
		elseif WarMenu.IsMenuOpened('MenuCatAnim') then
			if WarMenu.Button("Cat: Claw Sharpen") then
			TriggerEvent("lto_pedmenu:catclaw")
...
AddEventHandler('lto_pedmenu:dogdrink', function()
   local playerPed = PlayerPedId()
    TaskStartScenarioInPlace(playerPed, GetHashKey('WORLD_ANIMAL_DOG_DRINK_GROUND'), 17500, true, false, false, false)
	Citizen.Wait(17500)
