...
Citizen.CreateThread(function()
    while true do
		...
		if GetDistanceBetweenCoords(playerCoords, -319.0, 762.52, 117.43, true) < 1 then
            drawtext("Press G Para Sair", 0.15, 0.13, 0.3, 0.3, true, 255, 255, 255, 255, true, 10000)
			if IsControlJustReleased(0, othercontrols["G"]) then
				SetEntityCoords(PlayerPedId(),-320.5,762.26,116.43)
			end
		elseif GetDistanceBetweenCoords(playerCoords, 2630.99,-1223.89,59.58, true) < 1 then
            drawtext("Press G Para Sair", 0.15, 0.13, 0.3, 0.3, true, 255, 255, 255, 255, true, 10000)
			if IsControlJustReleased(0, othercontrols["G"]) then
				SetEntityCoords(PlayerPedId(),2632.6, -1223.79, 59.59)
			end
		elseif GetDistanceBetweenCoords(playerCoords, 2951.33,1333.67,44.45, true) < 1 then
            drawtext("Press G Para Sair", 0.15, 0.13, 0.3, 0.3, true, 255, 255, 255, 255, true, 10000)
			if IsControlJustReleased(0, othercontrols["G"]) then
				SetEntityCoords(PlayerPedId(),2950.42, 1332.15, 44.44)
			end
		elseif GetDistanceBetweenCoords(playerCoords, -1814.95,-372.54,166.50, true) < 1 then
            drawtext("Press G Para Sair", 0.15, 0.13, 0.3, 0.3, true, 255, 255, 255, 255, true, 10000)
			if IsControlJustReleased(0, othercontrols["G"]) then
				SetEntityCoords(PlayerPedId(),-1816.45, -372.44, 166.50)
			end
		elseif GetDistanceBetweenCoords(playerCoords, 2986.72,570.02,47.87, true) < 1 then
            drawtext("Press G Para Sair", 0.15, 0.13, 0.3, 0.3, true, 255, 255, 255, 255, true, 10000)
			if IsControlJustReleased(0, othercontrols["G"]) then
				SetEntityCoords(PlayerPedId(),2986.31, 568.27, 47.85)
			end
		elseif GetDistanceBetweenCoords(playerCoords, 1338.22,-1379.38,84.28, true) < 1 then
            drawtext("Press G Para Sair", 0.15, 0.13, 0.3, 0.3, true, 255, 255, 255, 255, true, 10000)
			if IsControlJustReleased(0, othercontrols["G"]) then
				SetEntityCoords(PlayerPedId(),1340.11, -1379.6, 84.28)
			end
		end
	end
end)
