...
Config.Prompts = {
    { label = ("Tome um banho($0.50)"), id = "START_BATHING" },

	{ label = "Lavar-se", id = "SCRUB", control = `INPUT_CONTEXT_X`, time = 2000 },
    { label = ("Peça um banho de luxo($1)"), id = "REQUEST_DELUXE_BATHING" },

	{ label = "Sair", id = "STOP_BATHING", control = `INPUT_INTERACT_NEG` }
}
