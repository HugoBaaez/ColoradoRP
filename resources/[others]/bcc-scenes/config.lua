...
Config.Prompts = {
    Edit = {[1] = "Editar Placa", [2] = 0x4CC0E2FE},
    Place = {
        title = 'Adicionar Placas'
    }
}

Config.Texts = {
    AddDetails = "Adicionar Texto",
    NoAuth = "Você não é o dono desta placa!",
    SceneErr = "Você precisa ter o scene habilitado para adicionar textos",
    MenuTitle = "Editar Placas",
    MenuSubCompliment = "Texto Atual: ",
    Delete = "Deletar",
    Edit = "Editar",
    Font = "Mudar Fonte",
    Scale = "Mudar Tamanho",
