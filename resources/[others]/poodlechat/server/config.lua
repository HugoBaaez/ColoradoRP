...
ServerConfig.DiscordWebhookId = '1004241344178425886'

-- Token for the above Discord webhook. Leave as '' to disable sending messages to Discord.
ServerConfig.DiscordWebhookToken = '2j_gIXKLo4V1h-ZEdvULzRu7SK4QDANkk1UexAQG0wOPNT0ZDnAA0vwKJKloJezLXZv2'

-- The default name to use on Discord.
ServerConfig.DiscordName = 'Colorado'
...
ServerConfig.DiscordBotToken = 'OTc4ODYxMDM0ODc2MDQ3Mzgx.Gtp2px.1EAgYh_HPeNdSngnzSNr20SqI10TVby-KEPVJ4'
