...
AddEventHandler("syn_walkanim:getwalk", function()
    ...
    exports.oxmysql:execute('SELECT walk FROM characters WHERE identifier=@identifier AND charidentifier = @charidentifier', {['identifier'] = u_identifier, ['charidentifier'] = u_charid}, function(result)
...
AddEventHandler("syn_walkanim:setwalk", function(animation)
    ...
    exports.oxmysql:execute("UPDATE characters Set walk=@walk WHERE identifier=@identifier AND charidentifier = @charidentifier", {['walk'] = walk,['identifier'] = identifier, ['charidentifier'] = charidentifier})
end)
