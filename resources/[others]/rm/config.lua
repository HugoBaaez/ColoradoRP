        ...
        data = {                                    -- Data that is passed to Javascript
            ...
            wheels = {			-- Array of wheels to display
                ...
                },
                {
                    ...
                    labels = {"imgsrc:endemote.png", "imgsrc:reload.png","imgsrc:cloths.png", "imgsrc:walkstyle.png", "imgsrc:emote.png","imgsrc:job.png"},
                    commands = {"annullere", "rc","clothingmenu", "walkstyle", "animations","job"}
                }
            }
        }
    }
        ...
        data = {
            ...
            wheels = {
                ...
                },
                {
                    ...
                    labels = {"imgsrc:sjob.png", "imgsrc:pb.png", "imgsrc:callp.png", "imgsrc:calld.png","imgsrc:ca.png"},
                    commands = {"showjob", "paybills ","alertpolice", "alertdoctor","calert"}
                },
            }
        }
    },
        ...
        data = {
            ...
            wheels = {
                ...
                },
                {
                    ...
                    commands = {"sleeves", "sleeves2", "bandana", "hat", "eyewear", "mask", "neckwear",  "undress", "dress"}
                },
                {
                    navAngle = 270,
                    ...
                    commands = {"suspender", "vest", "coat", "ccoat", "bow", "armor", "poncho", "cloack", "glove", "rings", "bracelet", "neckties", "shirt"}
                },
                {
                    navAngle = 270,
                    ...
                    commands = { "satchels", "gunbeltaccs", "belt", "buckle", "pant", "skirt", "chap", "boots", "spurs", "spats"}
                },
            }
        }
    },
        ...
        data = {
            ...
            wheels = {
                ...
                },
                {
                    ...
                    commands = {"lusket", "kylling", "thumbsup", "thumbsdown", "gorilla", "holdøje", "klap", "grineaf", "grine", "udfordre", "luftkys", "spejl", "anotar", "tjekur", "flex", "trussel"}
                }
            }
        }
    },
