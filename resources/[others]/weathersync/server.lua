...
AddEventHandler('txAdmin:events:scheduledRestart', function(eventData)
    if eventData.secondsRemaining == 1800 then
            ...
            TriggerEvent('weathersync:ChangeWeather',"OVERCASTDARK",500,false)
...
AddEventHandler('txAdmin:events:scheduledRestart', function(eventData)
    if eventData.secondsRemaining == 600 then
            ...
            TriggerEvent('weathersync:ChangeWeather',"HURRICANE",500,false)
...
AddEventHandler('txAdmin:events:scheduledRestart', function(eventData)
    if eventData.secondsRemaining == 300 then
            ...
            TriggerEvent('weathersync:ChangeWeather',"THUNDERSTORM",500,false)
