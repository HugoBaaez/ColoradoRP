...
Config.adminwebhook = "https://discord.com/api/webhooks/1032666512248557649/zIwoweKsb8n5eNsD805WLFLdlkTodFrq4ak3RbNR_U1Q3qremnEm_qRZL3KtHe1PaFl0"
...
Config.playerstoretax = 150 -- how much is the tax for player owned stores
...
Config.weeklyrepo = true -- same as above but weekly instead of monthly, only of of the 2 active. 
Config.repotime2 ={ 
    day1 = 15,
    day2 = 30,
    --day3 = 17,
