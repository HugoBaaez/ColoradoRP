...
Config.adminwebhook = "https://discord.com/api/webhooks/990827422586908702/S062ZH58QixrX_pxToR6VDHdJky5-ZcbfsGyLGJIeT0U46vM81lYwSLSlIjBTpC8FIs5"
...
Config.restarttime = {759} --this is the server restart time    
...
Config.maxclan = 15 -- set to 0 if you want unlimited clan members for each clan
----------------------
...
Config.raidcooldowncycles = 7 -- this is related to your server restart cycle.  set to 12 a camp can be raided once every 3 days (12 restart cycles)
...
Config.clancountraid = 3 -- this is the number of clan members that have to be online to allow a camp to be raided. set to 0 if you want camps to be raided when all members are offline. setting to 2 means only allowed to be raided if atleast 2 clan members are online
Config.raidtimer = 20 -- raiders have to wait in minutes between when they start the raid until they can lockpick. this gives the clan members a chance to respond to the raid. 
...
Config.disablepoisonondeath = true -- disable poison effect on death meaning a player dying will remove poison. leave as true if u want the poison to remain even if the player died
...
----------------------
Config.adminfurniresetcommand = "resetfurni" -- reset furniture to the unpitched state for a clan /command clanid 
...
-----------------
Config.huntingwagoncost = 100 -- cost to buy a hunting wagon for the camp
...
Config.randomizedsaleprice = false -- set to true if you want to randomize sale price according to the Config.randomprice
Config.randomprice = {min = 6,max = 10} -- money the player makes per stock piece is a random number between min and max multiplied by the amount of stock
Config.statifprice = 6 -- sale price per stock if Config.randomizedsaleprice is set to false. 
------------------------ stew config 
...
Config.stewpot = { 
    {
        ...
        recipie = { 
            {label = "Carne Animal",item = "meat", count = 5},
        },
        stats = {
            hunger = 10,
            thirst = 10,
    ...
    },
    {
        ...
        timeinminutes = 15, 
        recipie = { 
            {label = "Carne Animal",item = "meat", count = 3},
            {label = "Frutas Escuras",item = "Black_Berry", count = 5},
        },
        stats = {
            hunger = 20,
            thirst = 20,
    ...
    },
    {
        ...
        recipie = { 
            {label = "Carne Animal",item = "meat", count = 3},
            {label = "Frutas Escuras",item = "Black_Berry", count = 5},
            {label = "Erva Medicinal",item = "Burdock_Root", count = 2},
    ...
    },
    {
        ...
        recipie = { 
            ...
            {label = "Frutas Escuras",item = "Black_Berry", count = 5},
            {label = "Erva medicinal",item = "Burdock_Root", count = 2},
            {label = "Cenoura Selvagem",item = "Wild_Carrot", count = 3},
        },
        stats = {
            hunger = 40,
            thirst = 40,
