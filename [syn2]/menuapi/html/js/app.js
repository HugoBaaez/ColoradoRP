                                    ...
                                    if (elem.value > min) {
                                        if(typeof elem.hop != 'undefined'){	
                                            if (Number.isInteger(elem.hop)) {
                                                elem.value = elem.value - elem.hop// limit to 1 decimal place

                                            }else {
                                                elem.value = (
                                                    Number(elem.value) - Number(elem.hop)
                                                  ).toFixed(2); // limit to 1 decimal place
                                            }
											 if (elem.value < min){
                                               elem.value = min
											 }
                                    ...
                                    if (typeof elem.max != 'undefined' && elem.value < elem.max) {
										...
										if( typeof elem.hop != 'undefined'){
                                            ...
                                            if (Number.isInteger(elem.hop)) {
                                                ...
                                                elem.value = (Number(elem.value) + Number(elem.hop)).toFixed(2); // limit to 1 decimal place
